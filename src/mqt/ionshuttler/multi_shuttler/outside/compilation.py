...
<<<<<<< HEAD:src/mqt/ionshuttler/multi_shuttler/outside/compilation.py
        for _ in range(7):
=======
        first_line = ''
        for _f in range(7):
            prev_line = first_line
>>>>>>> 3c76de38036f50eb4300e81651cb760f8220605f:src/mqt/ionshuttler/multi_shuttler/Outside/compilation.py
